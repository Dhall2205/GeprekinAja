	<div class="col-md-3 panel" style="margin-top: 1em; background-color: #00FFFF; box-shadow: 3px 5px 5px #888888;">
        <div class="panel-title">
          <h4 style="margin-top: 1em;"><b>Pemilihan Dosen Terbaik</b></h4>     
          <hr />  
        </div>
...
<footer class="panel-footer text-center" style="margin-top: 2em;">
	<p>Copyright &copy; <?php echo date('Y'); ?> UTU</p>
</footer>
