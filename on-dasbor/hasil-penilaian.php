...
?>
			<div class="col-md-12">
				<h2>Penilaian Dosen Pembimbing Akademik Terbaik dengan Metode TOPSIS</h2>
				<hr>
				<p>
					<b>Lihat Dosen PA Terpilih</b> <a href='#' class='btn btn-success glyphicon glyphicon-search' data-target='#ModalView' data-toggle='modal' title='Lihat guru Terpilih'></a> 
				...
				<p>
					...
					<p id="hasil_terpilih">dosen pembimbing akademik terbaik yang terpilih adalah <b><?php echo "$nama_terpilih $A_terpilih"; ?></b> 
			...
			<div class="modal-dialog">
    			<div class="modal-content">
        			...
        			<div class="modal-header">
            			...
            			<h4 class="modal-title" id="myModalLabel">Dosen pembimbing Akademik Terbaik yang Terpilih</h4>
        			</div>
