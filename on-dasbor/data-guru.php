									...
									while ($row = $result->fetch_object()) {
										...
										<tr>
											...
											<td class="text-center">
												<a href='#' class='open_modal_edit btn btn-success glyphicon glyphicon-pencil' data-target='#ModalEdit' data-toggle='modal' id="<?php echo $row->id; ?>" title='Edit Data Dosen'></a>
												<a href='#' class='btn btn-danger glyphicon glyphicon-trash' data-target='#ModalDelete' data-toggle='modal' onclick="confirm_delete('proses_hapus_guru.php?&id=<?php echo $row->id; ?>');" title='Hapus Data Dosen'></a>
											</td>
										</tr>
							<?php
									}
